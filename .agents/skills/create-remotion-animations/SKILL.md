...
description: "Analiza vídeos y transcripciones, decide dónde una ayuda visual aporta valor, diseña, audita e implementa animaciones cortas y diseño sonoro con Remotion, las valida y las entrega por clip con guía de montaje. Usar dentro de YouTube Edit cuando el usuario pida crear o mejorar motion graphics, gráficas animadas, porcentajes o números destacados, comparativas, diagramas, explicaciones visuales, efectos de sonido sincronizados, overlays transparentes o un paquete de animaciones asociado a clips de YouTube."
---
...
6. Leer [delivery-contract.md](references/delivery-contract.md) cuando haya que preparar un paquete para el editor.
7. Leer [sound-design.md](references/sound-design.md) cuando el usuario pida efectos, audio integrado o una variante sonorizada.
8. Cargar también `remotion-best-practices` cuando esté disponible y consultar solo sus reglas pertinentes, especialmente animaciones, charts, compositions, parameters, sequencing, timing, measuring-text, audio, sfx y transparent-videos.
...
- Preparar un plan antes de programar: clip, timestamp aproximado, duración, idea, texto autorizado, tipo de pieza, composición y prioridad.
...
- Mantener una variante silenciosa aunque se entregue otra sonorizada. Sincronizar cada efecto con una transformación visible y exponer mezcla y mute como props.
...
datos, comparativas o procesos. Entrégalas por número de clip.
```
